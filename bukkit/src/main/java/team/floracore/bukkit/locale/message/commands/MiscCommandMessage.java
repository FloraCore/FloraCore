...
public interface MiscCommandMessage extends AbstractMessage {
    ...
    Args3<String, String, String> SET_DATA_SUCCESS = (key, value, target) -> AbstractMessage.prefixed(translatable()
                                                                                                              // 成功将 {2} 的数据键 {0} 设置为 {1}
                                                                                                              .key("floracore.command.generic.data.set")
                                                                                                              .color(GREEN)
                                                                                                              .args(text().color(
                                                                                                                                  WHITE)
                                                                                                                          .append(text(
                                                                                                                    ...
                                                                                                                    text().color(
                                                                                                                          ...
                                                                                                                          .append(text(
                                                                                                                                  '\''))
                                                                                                                          .append(AbstractMessage.formatColoredValue(
                                                                                                                                  value))
                                                                                                                          .append(text(
                                                                                                                                  '\'')),
                                                                                                                    text().color(
    ...
    Args4<String, String, String, Duration> SET_DATA_TEMP_SUCCESS = (key, value, target, duration) -> AbstractMessage.prefixed(
            translatable()
                    // 成功中将 {2} 的数据键 {0} 设置为 {1}, 有效期\: {3}
                    .key("floracore.command.generic.data.set-temp")
                    .color(GREEN)
    ...
    Args2<String, String> DOESNT_HAVE_DATA = (target, key) -> AbstractMessage.prefixed(translatable()
                                                                                               // {0} 没有设置数据键 {1}
                                                                                               .key("floracore.command.generic.data.doesnt-have")
                                                                                               .color(RED)
                                                                                               .args(text().color(AQUA)
                                                                                                           .append(text(
                                                                                                                   target)),
                                                                                                     text().color(WHITE)
                                                                                                           .append(text(
    ...
    Args2<String, String> UNSET_DATA_SUCCESS = (key, target) -> AbstractMessage.prefixed(translatable()
                                                                                                 // 成功中为 {1} 取消设置数据键 {0}
                                                                                                 .key("floracore.command.generic.data.unset")
                                                                                                 .color(GREEN)
                                                                                                 .args(text().color(
                                                                                                                     WHITE)
                                                                                                             .append(text(
    ...
    Args2<String, DataType> DATA_CLEAR_SUCCESS = (target, type) -> AbstractMessage.prefixed(translatable()
                                                                                                    // {0} 的数据({1})已被清除
                                                                                                    .key("floracore.command.generic.data.clear")
                                                                                                    .color(GREEN)
                                                                                                    // target
                                                                                                    .args(text().color(
                                                                                                                        AQUA)
