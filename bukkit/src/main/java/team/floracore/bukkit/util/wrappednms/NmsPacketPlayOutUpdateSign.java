...
public interface NmsPacketPlayOutUpdateSign extends NmsPacket {
    static NmsPacketPlayOutUpdateSign newInstance(NmsWorld world, NmsBlockPosition blockPosition, NmsIChatBaseComponentArray iChatBaseComponents) {
    ...
    NmsPacketPlayOutUpdateSign staticNewInstance(NmsWorld world, NmsBlockPosition blockPosition, NmsIChatBaseComponentArray iChatBaseComponents);
