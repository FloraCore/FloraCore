...
@WrappedBukkitClass({@VersionName(value = "nms.PacketPlayOutOpenSignEditor", maxVer = 17), @VersionName(value = "net.minecraft.network.protocol.game.PacketPlayOutOpenSignEditor", minVer = 17)})
