...
public interface NmsNBTBase extends WrappedBukkitObject {
    List<Class<? extends NmsNBTBase>> NBTWrappers = Lists.newArrayList(NmsNBTTagByte.class, NmsNBTTagCompound.class, NmsNBTTagInt.class, NmsNBTTagList.class, NmsNBTTagLong.class, NmsNBTTagShort.class, NmsNBTTagDouble.class, NmsNBTTagString.class);
