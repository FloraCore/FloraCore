...
public class Inventories {
	...
	private static final int INVENTORY_SIZE = BukkitWrapper.version >= 9 ? 41 : 40;
	...
	private static InventoryData parseInventoryData(final Inventory inventory,
		...
		// Convert empty armor slots to partial slots if we have armor items in the inventory, otherwise remove them
