...
public interface NmsPacketPlayOutPlayerInfo extends NmsPacket {
    static NmsPacketPlayOutPlayerInfo newInstance(NmsEnumPlayerInfoAction nmsEnumPlayerInfoAction, Iterable nmsEntityPlayers) {
    ...
    NmsPacketPlayOutPlayerInfo staticNewInstance(NmsEnumPlayerInfoAction nmsEnumPlayerInfoAction, Iterable nmsEntityPlayers);
}
