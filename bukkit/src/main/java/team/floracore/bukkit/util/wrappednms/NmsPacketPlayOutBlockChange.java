...
@WrappedBukkitClass({@VersionName(value = "nms.PacketPlayOutBlockChange", maxVer = 17),
		@VersionName(value = "net.minecraft.network.protocol.game.PacketPlayOutBlockChange", minVer = 17)})
