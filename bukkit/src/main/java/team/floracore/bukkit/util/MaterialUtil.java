...
public final class MaterialUtil {
    ...
    static {
        HELMETS = EnumUtil.getAllMatching(Material.class,
                "LEATHER_HELMET",
                "CHAINMAIL_HELMET",
                "IRON_HELMET",
                "GOLD_HELMET",
        ...
        CHESTPLATES = EnumUtil.getAllMatching(Material.class,
                "LEATHER_CHESTPLATE",
        ...
        LEGGINGS = EnumUtil.getAllMatching(Material.class,
                "LEATHER_LEGGINGS",
                "CHAINMAIL_LEGGINGS",
                "IRON_LEGGINGS",
                "GOLD_LEGGINGS",
        ...
        BOOTS = EnumUtil.getAllMatching(Material.class,
                "LEATHER_BOOTS",
                "CHAINMAIL_BOOTS",
                "IRON_BOOTS",
                "GOLD_BOOTS",
        ...
        BEDS = EnumUtil.getAllMatching(Material.class,
                "BED",
                "BED_BLOCK",
                "WHITE_BED",
                "ORANGE_BED",
        ...
        BANNERS = EnumUtil.getAllMatching(Material.class,
                "BANNER",
                "WHITE_BANNER",
                "ORANGE_BANNER",
                "MAGENTA_BANNER",
        ...
        LEATHER_ARMOR = EnumUtil.getAllMatching(Material.class,
                "LEATHER_HELMET",
                "LEATHER_CHESTPLATE",
                "LEATHER_LEGGINGS",
                "LEATHER_BOOTS");
        ...
        MOB_HEADS = EnumUtil.getAllMatching(Material.class,
                "SKELETON_SKULL",
                "SKELETON_WALL_SKULL",
        ...
        POTIONS = EnumUtil.getAllMatching(Material.class,
                "POTION",
                "SPLASH_POTION",
                "LINGERING_POTION",
                "TIPPED_ARROW");

        SIGN_POSTS = EnumUtil.getAllMatching(Material.class,
                "SIGN",
                "SIGN_POST",
                "ACACIA_SIGN",
                "BIRCH_SIGN",
        ...
        WALL_SIGNS = EnumUtil.getAllMatching(Material.class,
                "WALL_SIGN",
                "ACACIA_WALL_SIGN",
                "BIRCH_WALL_SIGN",
                "DARK_OAK_WALL_SIGN",
