package team.floracore.paper.loader;

import org.bukkit.plugin.java.*;
import team.floracore.common.loader.*;

public class BukkitLoaderPlugin extends JavaPlugin {
    private static final String JAR_NAME = "floracore-paper.jarinjar";
    private static final String BOOTSTRAP_CLASS = "team.floracore.paper.FCBukkitBootstrap";
