...
public class ClassReader {
     ...
     *                            will not
     *                            be parsed: its byte array value will be passed unchanged to the ClassWriter. <i>This
     *                            may
     *                            corrupt it if this value contains references to the constant pool, or has
     *                            syntactic or
     ...
     *                                          attribute, false it is a RuntimeInvisibleParameterAnnotations
     *                                          attribute.
     */
