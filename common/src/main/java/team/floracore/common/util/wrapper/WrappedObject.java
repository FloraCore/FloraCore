                                ...
                                case 0:
                                    ...
                                    if (accessByForce) {
                                        ...
                                        mn.visitMethodInsn(Opcodes.INVOKEVIRTUAL,
                                                ...
                                                "invokeExact",
                                                getDesc(Modifier.isStatic(rm.getModifiers()) ? new Class[0] : new Class[]{rm.getDeclaringClass()},
                                                        ((Field) rm).getType()),
                                                false);
                                        if (WrappedObject.class.isAssignableFrom(m.getReturnType())) {
                                        ...
                                        mn.visitFieldInsn(Modifier.isStatic(rm.getModifiers()) ? Opcodes.GETSTATIC : Opcodes.GETFIELD,
                                ...
                                case 1:
                                    if (accessByForce || Modifier.isFinal(rm.getModifiers())) {
                                        ...
                                        mn.visitMethodInsn(Opcodes.INVOKEVIRTUAL,
                                                getType(MethodHandle.class),
                                                "invokeExact",
                                                getDesc(Modifier.isStatic(rm.getModifiers()) ? new Class[]{((Field) rm).getType()} : new Class[]{rm.getDeclaringClass(), ((Field) rm).getType()},
                                                        void.class),
                                                false);
                                        ...
                                        mn.visitFieldInsn(Modifier.isStatic(rm.getModifiers()) ? Opcodes.PUTSTATIC : Opcodes.PUTFIELD,
