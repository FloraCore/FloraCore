...
public class ItemBuilder {
    ...
    /**
     * Initializes the ItemBuilder with {@link org.bukkit.Material}, Amount and
     * DisplayName
     */
    ...
    /**
     * Initializes the ItemBuilder with {@link org.bukkit.Material} and Displayname
     */
    ...
    /**
     * Initializes the ItemBuilder with a {@link org.bukkit.inventory.ItemStack}
     */
    ...
    /**
     * Initializes the ItemBuilder with a
    ...
    /**
     * Initializes the ItemBuilder with an already existing
     * {@link ItemBuilder}
     *
     * @deprecated Use the already initialized {@code ItemBuilder} Instance to
     * improve performance
     */
    @Deprecated
    ...
    public ItemBuilder lore(Component line) {
        return lore(SERIALIZER.serialize(line));
    }
     ...
     *
     * @param replace Determinate if it should be replaced or not
     */
    ...
    /**
     * Toggles allotment of stack sizes under 1 and above 64
     */
