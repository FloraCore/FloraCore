...
public final class ReflectionWrapper {
    ...
    public static Object getPlayerField(Player p, String name) {
        Object getHandle = invokeMethod(getMethod(p.getClass(), "getHandle"), p);
        return getFieldValue(getField(getHandle.getClass(), name), getHandle);
    }
