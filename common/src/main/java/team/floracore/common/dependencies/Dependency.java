...
public enum Dependency {
	...
	CLOUD_CORE("cloud{}commandframework", "cloud-core",
			"1.8.4",
			"AxFe1+8dC9YFzrKaGC+t2P460M8agmzeAR++AVkW0Fk=",
	...
	CLOUD_PAPER("cloud{}commandframework",
			"cloud-paper",
			"1.8.4",
			"QWBHijopKTHPOEGXC2F52aqbqb6TUvem5P5KOsoFh7o=",
			Relocation.of("cloud", "cloud{}commandframework")),
	CLOUD_BUKKIT("cloud{}commandframework",
			"cloud-bukkit",
			"1.8.4",
			"bRjkrSzmqkW4mcqZBiKBKYIG6s6PBfe3l6kHBDmlcM8=",
			Relocation.of("cloud", "cloud{}commandframework")),
	...
	BUKKIT_GUI("com.huanmeng-qwq",
			"Bukkit-Gui",
			"2.1.3",
			"pyAUf+KaJw2CKuwEQ7Q7emCQyZagVybafJMuLbx8OVM="),
	...
	MAXMIND_DB("com{}maxmind{}db",
			"maxmind-db",
			"2.0.0",
			"Y14Hg56wzr2cqibdJ6dbFACMLjG1iWiNdXEUEirI2sI=",
			Relocation.of("maxmind", "com{}maxmind")),
	JAVATAR("javatar",
			"javatar",
			"2.5",
